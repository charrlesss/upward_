...
export default function ProductionReport() {
  ...
  async function generateReport() {
    ...
    try {
      const response = await myAxios.post('/reports/reports/production-report', reportDetails, {
          ...
          newTab.document.write(`
            <script>
              document.getElementById('excel').onclick = function() {
                ...
                fetch('${process.env.REACT_APP_API_URL}/reports/reports/production-report-to-excel', {
                method: 'POST',
                headers: {
